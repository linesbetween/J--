...
class JavaCCParser implements JavaCCParserConstants {
    ...
    try {
      ...
      classBody = classBody();
        ...
        {if (true) return new JClassDeclaration( line, mods,
            name, superClass, classList, classBody );}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JMember memberDecl(ArrayList<String>  mods) throws ParseException {
    ...
    TypeName qI = null;
    ArrayList<TypeName> qIList = new ArrayList<TypeName>();
    try {
  ...
  final private JStatement statement() throws ParseException {
    ...
    ArrayList<JStatement> statements = new ArrayList<JStatement>();
    JForInit forInitStatement = null;
    JExpression forExpression = null;
    ArrayList<JStatement> forUpdateStatement = new ArrayList<JStatement>();
    JStatement astatement = null;
    JBlock block = null;
    JBlock catchBlock = null;
    JBlock finalBlock = null;
    JFormalParameter fp = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LCURLY:
        statement = block();
      ...
      case FOR:
        ...
        astatement = statement();
          statement = new JForStatement(line, forInitStatement, forExpression,
                                              forUpdateStatement, astatement);
        break;
      case WHILE:
      ...
      case TRY:
        ...
        default:
         ...
         statement =  new JTryStatement (line, block, fp,catchBlock, finalBlock);
        break;
      case SWITCH:
  ...
  final private JForInit forInit() throws ParseException {
        int line = 0;
        JStatement astateexpr = null;
        //ArrayList<JStatement> stateexprs =
        //	new ArrayList<JStatement>();
        JVariableDeclaration decl = null;
        ...
        ArrayList <String> mods = new ArrayList<String>();
        JStatement singleStatement = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case FALSE:
      case NEW:
      ...
      case STRING_LITERAL:
         line = token.beginLine;
        astateexpr = statementExpression();
         statements.add(astateexpr);
        label_17:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
      ...
      case LONG:
        ...
        vdecls = variableDeclarators(type);
         singleStatement = new JVariableDeclaration( line, mods, vdecls );
 ...
 {if (true) return new JForInit(line,statements);}
    throw new Error("Missing return statement in function");
  }
 ...
 {if (true) return lhs;}
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x20000000,0x81010400,0x80010000,0x81010400,0x1000400,0x1000400,0x400000,0x0,0x10000000,0x0,0x400000,0x1108c00,0x1108c00,0x1108c00,0x108800,0x0,0x0,0x0,0x0,0x108800,0x108800,0x0,0x0,0x0,0x108800,0xc989800,0xc881000,0x908800,0x800000,0x800000,0x4000,0x2000000,0x42000,0x800000,0x0,0xc881000,0x0,0x108800,0x0,0x908800,0x0,0x42000,0xc989800,0x1000,0x42000,0x0,0x0,0x800000,0x0,0x800000,0x0,0x800000,0x108800,0x108800,0x0,0x0,0x108800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x800000,0x0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0x108800,0x0,0x0,0x0,0x800000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x10,0x0,0x2e0,0x0,0x2e0,0x2e0,0x2e0,0x0,0x0,0x0,0x0,0x0,0x402e3,0x402e3,0x402e3,0x40003,0x0,0x0,0x8000,0x0,0x3,0x40003,0x0,0x0,0x8000,0x3,0x325b790f,0x325b790c,0x3251280f,0x3251280c,0x3251280c,0x0,0x0,0x0,0x3251280c,0x0,0x325b790c,0x0,0x3,0x0,0x3251280f,0x0,0x0,0x325b790f,0x0,0x0,0x0,0x200000,0x3251280c,0x0,0x3251280c,0x0,0x3251280c,0x3,0x3,0x0,0x0,0x3,0x40200000,0x40200000,0x0,0x0,0x4000000,0x0,0x0,0x0,0x800000,0x800000,0x9000000,0x9000000,0x0,0x20100000,0x20100000,0x80000000,0x80000000,0x3251280c,0x10000000,0x1280c,0x0,0x2400000,0x2400000,0x0,0x0,0x0,0x0,0x0,0x0,0x1280c,0x3,0x0,0x0,0x0,0x10008,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x40000000,0x0,0x40000000,0x0,0x0,0x0,0x80000000,0x0,0x80000000,0x0,0x0,0x40000000,0x40000000,0x0,0x10000000,0x80000000,0x0,0x44000000,0x0,0x0,0x10000000,0x80000000,0x0,0x0,0x45000000,0x45000000,0x1000000,0x1000000,0x1000000,0x0,0x0,0x0,0x1000000,0x0,0x45000000,0x80000000,0x0,0x80000000,0x1000000,0x80000000,0x0,0x45000000,0x0,0x0,0x80000000,0x0,0x5000000,0x80000000,0x5000000,0x80000000,0x1000000,0x0,0x0,0x10000000,0x10000000,0x0,0x949570,0x949570,0x1,0x200000,0x0,0x80000,0x20000,0x400000,0x4,0x4,0x12000,0x12000,0x4a00,0x0,0x0,0x88,0x88,0x1000000,0x0,0x1000000,0x10000000,0x0,0x0,0x1000000,0x10000000,0x1000000,0x1000000,0x1000000,0x1000000,0x1000000,0x0,0x4000000,0x1000000,0x10000000,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x4,0x4,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x4,0x19c4,0x19c4,0x19c4,0x19c4,0x19c4,0x0,0x0,0x0,0x19c4,0x4,0x19c4,0x0,0x4,0x0,0x19c4,0x0,0x0,0x19c4,0x0,0x0,0x0,0x0,0x19c4,0x0,0x19c4,0x0,0x19c4,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x19c4,0x0,0x19c4,0x1,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x19c4,0x4,0x0,0x0,0x0,0x19c0,};
   }
