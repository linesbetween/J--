...
class JUCompleOp extends JUnaryExpression {

    /**
     * Constructs an AST node for a unary complement expression given its line 
    ...
    public JUCompleOp(int line, JExpression arg) {
        super(line, "~", arg);
    }
...
class JUPlusOp extends JUnaryExpression {
    ...
    /**
     * Constructs an AST node for a unary plus expression given its line 
       number, and the operand.
     * 
     * @param line
